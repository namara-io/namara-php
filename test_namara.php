<?php
	...
	class NamaraTest extends PHPUnit_Framework_TestCase {
		...
		public function test_get_base_path() {
			...
			$this->assertEquals($base_path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2');
		}

		public function test_get_path() {
			$path = $this->subject->get_path($this->dataset, $this->version, null);
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&');
		}

		public function test_get_path_limit() {
			$path = $this->subject->get_path($this->dataset, $this->version, (Object)array('limit' => 1));
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&limit=1');
		}

		public function test_get_path_offset() {
			$path = $this->subject->get_path($this->dataset, $this->version, (Object)array('offset' => 1));
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&offset=1');
		}
		...
		public function test_get_path_select() {
			...
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&select=facility_code');
		}

		public function test_get_path_sum() {
			$path = $this->subject->get_path($this->dataset, $this->version, (Object)array('sum' => 'facility_code'));
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&sum=facility_code');
		}

		public function test_get_path_avg() {
			$path = $this->subject->get_path($this->dataset, $this->version, (Object)array('avg' => 'facility_code'));
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&avg=facility_code');
		}

		public function test_get_path_min() {
			$path = $this->subject->get_path($this->dataset, $this->version, (Object)array('min' => 'facility_code'));
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&min=facility_code');
		}

		public function test_get_path_max() {
			$path = $this->subject->get_path($this->dataset, $this->version, (Object)array('max' => 'facility_code'));
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&max=facility_code');
		}
		...
		public function test_get_path_where() {
			...
			$this->assertEquals($path, 'https://api.namara.io/v0/data_sets/18b854e3-66bd-4a00-afba-8eabfc54f524/data/en-2?api_key=myapikey&where=facility_code%3E1000');
		}
